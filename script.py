...
# Configuration
WATCH_FOLDER = "C:\\Users\\niyit\\OneDrive\\Pictures\\Camera Roll"  # Folder where the camera saves pictures
...
CHECK_INTERVAL = 30  # Time to wait before uploading each picture (in seconds)
